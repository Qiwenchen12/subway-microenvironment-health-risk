% 提取列的数据
light_factor = table23.light_factor;
temperature_factor = table23.temperature_factor;
humidity_factor = table23.humidity_factor;
wind_factor = table23.wind_factor;
noise_factor = table23.noise_factor;
PM10_factor = table23.PM10_factor;
PM25_factor = table23.PM25_factor;
CO2_factor = table23.CO2_factor;
CO_factor = table23.CO_factor;
TVOC_factor = table23.TVOC_factor;
flowdensity_factor = table23.flowdensity_factor;
natural_factor = table23.natural_factor;
social_factor = table23.social_factor;
employee_factor = table23.employee_factor;
technical_factor = table23.technical_factor;
skill_factor = table23.skill_factor;
basiclocation_factor = table23.basiclocation_factor;
emergencylocation_factor = table23.emergencylocation_factor;
basicalconfiguration_factor = table23.basicalconfiguration_factor;
emergencyconfiguration_factor = table23.emergencyconfiguration_factor;
repair_factor = table23.repair_factor;
qualification_factor = table23.qualification_factor;
safety_factor = table23.safety_factor;
drill_factor = table23.drill_factor;
management_factor = table23.management_factor;
plan_factor = table23.plan_factor;
inspection_factor = table23.inspection_factor;
risk_factor = table23.risk_factor;
organization_factor = table23.organization_factor;
bacteria_factor = table23.bacteria_factor;
