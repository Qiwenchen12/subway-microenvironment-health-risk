% 提取列的数据
light_factor = table33.light_factor;
temperature_factor = table33.temperature_factor;
humidity_factor = table33.humidity_factor;
wind_factor = table33.wind_factor;
noise_factor = table33.noise_factor;
PM10_factor = table33.PM10_factor;
PM25_factor = table33.PM25_factor;
CO2_factor = table33.CO2_factor;
CO_factor = table33.CO_factor;
TVOC_factor = table33.TVOC_factor;
flowdensity_factor = table33.flowdensity_factor;
natural_factor = table33.natural_factor;
social_factor = table33.social_factor;
employee_factor = table33.employee_factor;
technical_factor = table33.technical_factor;
skill_factor = table33.skill_factor;
basiclocation_factor = table33.basiclocation_factor;
emergencylocation_factor = table33.emergencylocation_factor;
basicalconfiguration_factor = table33.basicalconfiguration_factor;
emergencyconfiguration_factor = table33.emergencyconfiguration_factor;
repair_factor = table33.repair_factor;
qualification_factor = table33.qualification_factor;
safety_factor = table33.safety_factor;
drill_factor = table33.drill_factor;
management_factor = table33.management_factor;
plan_factor = table33.plan_factor;
inspection_factor = table33.inspection_factor;
risk_factor = table33.risk_factor;
organization_factor = table33.organization_factor;
bacteria_factor = table33.bacteria_factor;
