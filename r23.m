% 提取列的数据
light_factor = table22.light_factor;
temperature_factor = table22.temperature_factor;
humidity_factor = table22.humidity_factor;
wind_factor = table22.wind_factor;
noise_factor = table22.noise_factor;
PM10_factor = table22.PM10_factor;
PM25_factor = table22.PM25_factor;
CO2_factor = table22.CO2_factor;
CO_factor = table22.CO_factor;
TVOC_factor = table22.TVOC_factor;
flowdensity_factor = table22.flowdensity_factor;
natural_factor = table22.natural_factor;
social_factor = table22.social_factor;
employee_factor = table22.employee_factor;
technical_factor = table22.technical_factor;
skill_factor = table22.skill_factor;
basiclocation_factor = table22.basiclocation_factor;
emergencylocation_factor = table22.emergencylocation_factor;
basicalconfiguration_factor = table22.basicalconfiguration_factor;
emergencyconfiguration_factor = table22.emergencyconfiguration_factor;
repair_factor = table22.repair_factor;
qualification_factor = table22.qualification_factor;
safety_factor = table22.safety_factor;
drill_factor = table22.drill_factor;
management_factor = table22.management_factor;
plan_factor = table22.plan_factor;
inspection_factor = table22.inspection_factor;
risk_factor = table22.risk_factor;
organization_factor = table22.organization_factor;
bacteria_factor = table22.bacteria_factor;
