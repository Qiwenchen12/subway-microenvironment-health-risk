% 提取列的数据
light_factor = table18.light_factor;
temperature_factor = table18.temperature_factor;
humidity_factor = table18.humidity_factor;
wind_factor = table18.wind_factor;
noise_factor = table18.noise_factor;
PM10_factor = table18.PM10_factor;
PM25_factor = table18.PM25_factor;
CO2_factor = table18.CO2_factor;
CO_factor = table18.CO_factor;
TVOC_factor = table18.TVOC_factor;
flowdensity_factor = table18.flowdensity_factor;
natural_factor = table18.natural_factor;
social_factor = table18.social_factor;
employee_factor = table18.employee_factor;
technical_factor = table18.technical_factor;
skill_factor = table18.skill_factor;
basiclocation_factor = table18.basiclocation_factor;
emergencylocation_factor = table18.emergencylocation_factor;
basicalconfiguration_factor = table18.basicalconfiguration_factor;
emergencyconfiguration_factor = table18.emergencyconfiguration_factor;
repair_factor = table18.repair_factor;
qualification_factor = table18.qualification_factor;
safety_factor = table18.safety_factor;
drill_factor = table18.drill_factor;
management_factor = table18.management_factor;
plan_factor = table18.plan_factor;
inspection_factor = table18.inspection_factor;
risk_factor = table18.risk_factor;
organization_factor = table18.organization_factor;
bacteria_factor = table18.bacteria_factor;
