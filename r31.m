% 提取列的数据
light_factor = table30.light_factor;
temperature_factor = table30.temperature_factor;
humidity_factor = table30.humidity_factor;
wind_factor = table30.wind_factor;
noise_factor = table30.noise_factor;
PM10_factor = table30.PM10_factor;
PM25_factor = table30.PM25_factor;
CO2_factor = table30.CO2_factor;
CO_factor = table30.CO_factor;
TVOC_factor = table30.TVOC_factor;
flowdensity_factor = table30.flowdensity_factor;
natural_factor = table30.natural_factor;
social_factor = table30.social_factor;
employee_factor = table30.employee_factor;
technical_factor = table30.technical_factor;
skill_factor = table30.skill_factor;
basiclocation_factor = table30.basiclocation_factor;
emergencylocation_factor = table30.emergencylocation_factor;
basicalconfiguration_factor = table30.basicalconfiguration_factor;
emergencyconfiguration_factor = table30.emergencyconfiguration_factor;
repair_factor = table30.repair_factor;
qualification_factor = table30.qualification_factor;
safety_factor = table30.safety_factor;
drill_factor = table30.drill_factor;
management_factor = table30.management_factor;
plan_factor = table30.plan_factor;
inspection_factor = table30.inspection_factor;
risk_factor = table30.risk_factor;
organization_factor = table30.organization_factor;
bacteria_factor = table30.bacteria_factor;
