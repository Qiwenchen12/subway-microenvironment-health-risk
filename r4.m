% 提取列的数据
light_factor = table3.light_factor;
temperature_factor = table3.temperature_factor;
humidity_factor = table3.humidity_factor;
wind_factor = table3.wind_factor;
noise_factor = table3.noise_factor;
PM10_factor = table3.PM10_factor;
PM25_factor = table3.PM25_factor;
CO2_factor = table3.CO2_factor;
CO_factor = table3.CO_factor;
TVOC_factor = table3.TVOC_factor;
flowdensity_factor = table3.flowdensity_factor;
natural_factor = table3.natural_factor;
social_factor = table3.social_factor;
employee_factor = table3.employee_factor;
technical_factor = table3.technical_factor;
skill_factor = table3.skill_factor;
basiclocation_factor = table3.basiclocation_factor;
emergencylocation_factor = table3.emergencylocation_factor;
basicalconfiguration_factor = table3.basicalconfiguration_factor;
emergencyconfiguration_factor = table3.emergencyconfiguration_factor;
repair_factor = table3.repair_factor;
qualification_factor = table3.qualification_factor;
safety_factor = table3.safety_factor;
drill_factor = table3.drill_factor;
management_factor = table3.management_factor;
plan_factor = table3.plan_factor;
inspection_factor = table3.inspection_factor;
risk_factor = table3.risk_factor;
organization_factor = table3.organization_factor;
bacteria_factor = table3.bacteria_factor;
