% 提取列的数据
light_factor = table14.light_factor;
temperature_factor = table14.temperature_factor;
humidity_factor = table14.humidity_factor;
wind_factor = table14.wind_factor;
noise_factor = table14.noise_factor;
PM10_factor = table14.PM10_factor;
PM25_factor = table14.PM25_factor;
CO2_factor = table14.CO2_factor;
CO_factor = table14.CO_factor;
TVOC_factor = table14.TVOC_factor;
flowdensity_factor = table14.flowdensity_factor;
natural_factor = table14.natural_factor;
social_factor = table14.social_factor;
employee_factor = table14.employee_factor;
technical_factor = table14.technical_factor;
skill_factor = table14.skill_factor;
basiclocation_factor = table14.basiclocation_factor;
emergencylocation_factor = table14.emergencylocation_factor;
basicalconfiguration_factor = table14.basicalconfiguration_factor;
emergencyconfiguration_factor = table14.emergencyconfiguration_factor;
repair_factor = table14.repair_factor;
qualification_factor = table14.qualification_factor;
safety_factor = table14.safety_factor;
drill_factor = table14.drill_factor;
management_factor = table14.management_factor;
plan_factor = table14.plan_factor;
inspection_factor = table14.inspection_factor;
risk_factor = table14.risk_factor;
organization_factor = table14.organization_factor;
bacteria_factor = table14.bacteria_factor;
