% 提取列的数据
light_factor = table19.light_factor;
temperature_factor = table19.temperature_factor;
humidity_factor = table19.humidity_factor;
wind_factor = table19.wind_factor;
noise_factor = table19.noise_factor;
PM10_factor = table19.PM10_factor;
PM25_factor = table19.PM25_factor;
CO2_factor = table19.CO2_factor;
CO_factor = table19.CO_factor;
TVOC_factor = table19.TVOC_factor;
flowdensity_factor = table19.flowdensity_factor;
natural_factor = table19.natural_factor;
social_factor = table19.social_factor;
employee_factor = table19.employee_factor;
technical_factor = table19.technical_factor;
skill_factor = table19.skill_factor;
basiclocation_factor = table19.basiclocation_factor;
emergencylocation_factor = table19.emergencylocation_factor;
basicalconfiguration_factor = table19.basicalconfiguration_factor;
emergencyconfiguration_factor = table19.emergencyconfiguration_factor;
repair_factor = table19.repair_factor;
qualification_factor = table19.qualification_factor;
safety_factor = table19.safety_factor;
drill_factor = table19.drill_factor;
management_factor = table19.management_factor;
plan_factor = table19.plan_factor;
inspection_factor = table19.inspection_factor;
risk_factor = table19.risk_factor;
organization_factor = table19.organization_factor;
bacteria_factor = table19.bacteria_factor;
