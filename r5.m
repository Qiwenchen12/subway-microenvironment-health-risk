% 提取列的数据
light_factor = table4.light_factor;
temperature_factor = table4.temperature_factor;
humidity_factor = table4.humidity_factor;
wind_factor = table4.wind_factor;
noise_factor = table4.noise_factor;
PM10_factor = table4.PM10_factor;
PM25_factor = table4.PM25_factor;
CO2_factor = table4.CO2_factor;
CO_factor = table4.CO_factor;
TVOC_factor = table4.TVOC_factor;
flowdensity_factor = table4.flowdensity_factor;
natural_factor = table4.natural_factor;
social_factor = table4.social_factor;
employee_factor = table4.employee_factor;
technical_factor = table4.technical_factor;
skill_factor = table4.skill_factor;
basiclocation_factor = table4.basiclocation_factor;
emergencylocation_factor = table4.emergencylocation_factor;
basicalconfiguration_factor = table4.basicalconfiguration_factor;
emergencyconfiguration_factor = table4.emergencyconfiguration_factor;
repair_factor = table4.repair_factor;
qualification_factor = table4.qualification_factor;
safety_factor = table4.safety_factor;
drill_factor = table4.drill_factor;
management_factor = table4.management_factor;
plan_factor = table4.plan_factor;
inspection_factor = table4.inspection_factor;
risk_factor = table4.risk_factor;
organization_factor = table4.organization_factor;
bacteria_factor = table4.bacteria_factor;
