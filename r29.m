% 提取列的数据
light_factor = table28.light_factor;
temperature_factor = table28.temperature_factor;
humidity_factor = table28.humidity_factor;
wind_factor = table28.wind_factor;
noise_factor = table28.noise_factor;
PM10_factor = table28.PM10_factor;
PM25_factor = table28.PM25_factor;
CO2_factor = table28.CO2_factor;
CO_factor = table28.CO_factor;
TVOC_factor = table28.TVOC_factor;
flowdensity_factor = table28.flowdensity_factor;
natural_factor = table28.natural_factor;
social_factor = table28.social_factor;
employee_factor = table28.employee_factor;
technical_factor = table28.technical_factor;
skill_factor = table28.skill_factor;
basiclocation_factor = table28.basiclocation_factor;
emergencylocation_factor = table28.emergencylocation_factor;
basicalconfiguration_factor = table28.basicalconfiguration_factor;
emergencyconfiguration_factor = table28.emergencyconfiguration_factor;
repair_factor = table28.repair_factor;
qualification_factor = table28.qualification_factor;
safety_factor = table28.safety_factor;
drill_factor = table28.drill_factor;
management_factor = table28.management_factor;
plan_factor = table28.plan_factor;
inspection_factor = table28.inspection_factor;
risk_factor = table28.risk_factor;
organization_factor = table28.organization_factor;
bacteria_factor = table28.bacteria_factor;
