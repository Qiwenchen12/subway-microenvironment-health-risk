% 提取列的数据
light_factor = table40.light_factor;
temperature_factor = table40.temperature_factor;
humidity_factor = table40.humidity_factor;
wind_factor = table40.wind_factor;
noise_factor = table40.noise_factor;
PM10_factor = table40.PM10_factor;
PM25_factor = table40.PM25_factor;
CO2_factor = table40.CO2_factor;
CO_factor = table40.CO_factor;
TVOC_factor = table40.TVOC_factor;
flowdensity_factor = table40.flowdensity_factor;
natural_factor = table40.natural_factor;
social_factor = table40.social_factor;
employee_factor = table40.employee_factor;
technical_factor = table40.technical_factor;
skill_factor = table40.skill_factor;
basiclocation_factor = table40.basiclocation_factor;
emergencylocation_factor = table40.emergencylocation_factor;
basicalconfiguration_factor = table40.basicalconfiguration_factor;
emergencyconfiguration_factor = table40.emergencyconfiguration_factor;
repair_factor = table40.repair_factor;
qualification_factor = table40.qualification_factor;
safety_factor = table40.safety_factor;
drill_factor = table40.drill_factor;
management_factor = table40.management_factor;
plan_factor = table40.plan_factor;
inspection_factor = table40.inspection_factor;
risk_factor = table40.risk_factor;
organization_factor = table40.organization_factor;
bacteria_factor = table40.bacteria_factor;
