% 提取列的数据
light_factor = table1.light_factor;
temperature_factor = table1.temperature_factor;
humidity_factor = table1.humidity_factor;
wind_factor = table1.wind_factor;
noise_factor = table1.noise_factor;
PM10_factor = table1.PM10_factor;
PM25_factor = table1.PM25_factor;
CO2_factor = table1.CO2_factor;
CO_factor = table1.CO_factor;
TVOC_factor = table1.TVOC_factor;
flowdensity_factor = table1.flowdensity_factor;
natural_factor = table1.natural_factor;
social_factor = table1.social_factor;
employee_factor = table1.employee_factor;
technical_factor = table1.technical_factor;
skill_factor = table1.skill_factor;
basiclocation_factor = table1.basiclocation_factor;
emergencylocation_factor = table1.emergencylocation_factor;
basicalconfiguration_factor = table1.basicalconfiguration_factor;
emergencyconfiguration_factor = table1.emergencyconfiguration_factor;
repair_factor = table1.repair_factor;
qualification_factor = table1.qualification_factor;
safety_factor = table1.safety_factor;
drill_factor = table1.drill_factor;
management_factor = table1.management_factor;
plan_factor = table1.plan_factor;
inspection_factor = table1.inspection_factor;
risk_factor = table1.risk_factor;
organization_factor = table1.organization_factor;
bacteria_factor = table1.bacteria_factor;
