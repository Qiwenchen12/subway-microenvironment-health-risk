% 提取列的数据
light_factor = table20.light_factor;
temperature_factor = table20.temperature_factor;
humidity_factor = table20.humidity_factor;
wind_factor = table20.wind_factor;
noise_factor = table20.noise_factor;
PM10_factor = table20.PM10_factor;
PM25_factor = table20.PM25_factor;
CO2_factor = table20.CO2_factor;
CO_factor = table20.CO_factor;
TVOC_factor = table20.TVOC_factor;
flowdensity_factor = table20.flowdensity_factor;
natural_factor = table20.natural_factor;
social_factor = table20.social_factor;
employee_factor = table20.employee_factor;
technical_factor = table20.technical_factor;
skill_factor = table20.skill_factor;
basiclocation_factor = table20.basiclocation_factor;
emergencylocation_factor = table20.emergencylocation_factor;
basicalconfiguration_factor = table20.basicalconfiguration_factor;
emergencyconfiguration_factor = table20.emergencyconfiguration_factor;
repair_factor = table20.repair_factor;
qualification_factor = table20.qualification_factor;
safety_factor = table20.safety_factor;
drill_factor = table20.drill_factor;
management_factor = table20.management_factor;
plan_factor = table20.plan_factor;
inspection_factor = table20.inspection_factor;
risk_factor = table20.risk_factor;
organization_factor = table20.organization_factor;
bacteria_factor = table20.bacteria_factor;
