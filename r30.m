% 提取列的数据
light_factor = table29.light_factor;
temperature_factor = table29.temperature_factor;
humidity_factor = table29.humidity_factor;
wind_factor = table29.wind_factor;
noise_factor = table29.noise_factor;
PM10_factor = table29.PM10_factor;
PM25_factor = table29.PM25_factor;
CO2_factor = table29.CO2_factor;
CO_factor = table29.CO_factor;
TVOC_factor = table29.TVOC_factor;
flowdensity_factor = table29.flowdensity_factor;
natural_factor = table29.natural_factor;
social_factor = table29.social_factor;
employee_factor = table29.employee_factor;
technical_factor = table29.technical_factor;
skill_factor = table29.skill_factor;
basiclocation_factor = table29.basiclocation_factor;
emergencylocation_factor = table29.emergencylocation_factor;
basicalconfiguration_factor = table29.basicalconfiguration_factor;
emergencyconfiguration_factor = table29.emergencyconfiguration_factor;
repair_factor = table29.repair_factor;
qualification_factor = table29.qualification_factor;
safety_factor = table29.safety_factor;
drill_factor = table29.drill_factor;
management_factor = table29.management_factor;
plan_factor = table29.plan_factor;
inspection_factor = table29.inspection_factor;
risk_factor = table29.risk_factor;
organization_factor = table29.organization_factor;
bacteria_factor = table29.bacteria_factor;
