% 提取列的数据
light_factor = table24.light_factor;
temperature_factor = table24.temperature_factor;
humidity_factor = table24.humidity_factor;
wind_factor = table24.wind_factor;
noise_factor = table24.noise_factor;
PM10_factor = table24.PM10_factor;
PM25_factor = table24.PM25_factor;
CO2_factor = table24.CO2_factor;
CO_factor = table24.CO_factor;
TVOC_factor = table24.TVOC_factor;
flowdensity_factor = table24.flowdensity_factor;
natural_factor = table24.natural_factor;
social_factor = table24.social_factor;
employee_factor = table24.employee_factor;
technical_factor = table24.technical_factor;
skill_factor = table24.skill_factor;
basiclocation_factor = table24.basiclocation_factor;
emergencylocation_factor = table24.emergencylocation_factor;
basicalconfiguration_factor = table24.basicalconfiguration_factor;
emergencyconfiguration_factor = table24.emergencyconfiguration_factor;
repair_factor = table24.repair_factor;
qualification_factor = table24.qualification_factor;
safety_factor = table24.safety_factor;
drill_factor = table24.drill_factor;
management_factor = table24.management_factor;
plan_factor = table24.plan_factor;
inspection_factor = table24.inspection_factor;
risk_factor = table24.risk_factor;
organization_factor = table24.organization_factor;
bacteria_factor = table24.bacteria_factor;
