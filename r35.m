% 提取列的数据
light_factor = table34.light_factor;
temperature_factor = table34.temperature_factor;
humidity_factor = table34.humidity_factor;
wind_factor = table34.wind_factor;
noise_factor = table34.noise_factor;
PM10_factor = table34.PM10_factor;
PM25_factor = table34.PM25_factor;
CO2_factor = table34.CO2_factor;
CO_factor = table34.CO_factor;
TVOC_factor = table34.TVOC_factor;
flowdensity_factor = table34.flowdensity_factor;
natural_factor = table34.natural_factor;
social_factor = table34.social_factor;
employee_factor = table34.employee_factor;
technical_factor = table34.technical_factor;
skill_factor = table34.skill_factor;
basiclocation_factor = table34.basiclocation_factor;
emergencylocation_factor = table34.emergencylocation_factor;
basicalconfiguration_factor = table34.basicalconfiguration_factor;
emergencyconfiguration_factor = table34.emergencyconfiguration_factor;
repair_factor = table34.repair_factor;
qualification_factor = table34.qualification_factor;
safety_factor = table34.safety_factor;
drill_factor = table34.drill_factor;
management_factor = table34.management_factor;
plan_factor = table34.plan_factor;
inspection_factor = table34.inspection_factor;
risk_factor = table34.risk_factor;
organization_factor = table34.organization_factor;
bacteria_factor = table34.bacteria_factor;
...
%删除重复项
[~, uniqueIndices] = unique(table35, 'rows', 'stable');
table35Unique = table35(uniqueIndices, :);

rows_table34Unique_noDup = table34{:,:};
rows_table35Unique = table35Unique{:,:};
[~, idx1] = ismember(rows_table35Unique,rows_table34Unique_noDup, 'rows');
table35 = table35Unique(~idx1, :);
