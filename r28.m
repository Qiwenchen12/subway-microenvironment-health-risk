% 提取列的数据
light_factor = table27.light_factor;
temperature_factor = table27.temperature_factor;
humidity_factor = table27.humidity_factor;
wind_factor = table27.wind_factor;
noise_factor = table27.noise_factor;
PM10_factor = table27.PM10_factor;
PM25_factor = table27.PM25_factor;
CO2_factor = table27.CO2_factor;
CO_factor = table27.CO_factor;
TVOC_factor = table27.TVOC_factor;
flowdensity_factor = table27.flowdensity_factor;
natural_factor = table27.natural_factor;
social_factor = table27.social_factor;
employee_factor = table27.employee_factor;
technical_factor = table27.technical_factor;
skill_factor = table27.skill_factor;
basiclocation_factor = table27.basiclocation_factor;
emergencylocation_factor = table27.emergencylocation_factor;
basicalconfiguration_factor = table27.basicalconfiguration_factor;
emergencyconfiguration_factor = table27.emergencyconfiguration_factor;
repair_factor = table27.repair_factor;
qualification_factor = table27.qualification_factor;
safety_factor = table27.safety_factor;
drill_factor = table27.drill_factor;
management_factor = table27.management_factor;
plan_factor = table27.plan_factor;
inspection_factor = table27.inspection_factor;
risk_factor = table27.risk_factor;
organization_factor = table27.organization_factor;
bacteria_factor = table27.bacteria_factor;
